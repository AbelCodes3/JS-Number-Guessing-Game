...
Everytime the user guesses a number the application will compare it to the randomly generated number and give feedback to the user such as "Too high, try again", "Too low, try again", and "Correct".
